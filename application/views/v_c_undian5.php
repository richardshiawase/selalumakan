...
<html>
	<head>
		...
		<?php echo link_tag(base_url().'/assets/css/main.css');?>
	</head>
	<body class="is-preload">
		...
		<!-- Header -->
			<section id="header">
				<header>
					<span class="image avatar"><!-- <img src="images/avatar.jpg" alt="" /> --><?php echo img('assets/images/avatar.jpg'); ?></span>
					<h1 id="logo"><a href="#">Richard Shiawase <?php echo $messageRecorded; ?></a></h1>
						...
						<!-- One -->
							<section id="one">
								<div class="image main" data-position="center">
									<?php echo img('assets/images/banner.jpg'); ?>
								</div>
								<div class="container">
									<header class="major">
										<h2>Read Only</h2>
